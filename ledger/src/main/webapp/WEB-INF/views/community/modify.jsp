		...
		<div class="col-lg-12">
			...
			<div class="card gb-card shadow mb-4">
				<div class="gb-card-header">
					<h6 class="gb-card-title">Community Modify 🛠️</h6>
				...
				<div class="gb-card-body">
					<form id="actionForm" action="/community/modify" method="post"
						...
						<div class="mb-3">
							<label class="form-label fw-bold" style="color: #3a2a00;">Content</label>
					...
					<div class="d-flex justify-content-end gap-2">
						<button type="button" class="gb-btn gb-btn-ghost btnList">LIST</button>

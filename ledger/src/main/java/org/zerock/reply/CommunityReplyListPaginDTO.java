...
public class CommunityReplyListPaginDTO {
	...
	private List<CommunityReplyDTO> communityReplyDTOList;  //전제 목록
	...
	public CommunityReplyListPaginDTO(List<CommunityReplyDTO> communityReplyDTOList, int totalCount, 
			int page, int size) {
		
		this.communityReplyDTOList = communityReplyDTOList; // 현재 페이지에 출력할 게시글 목록

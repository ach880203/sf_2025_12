...
@Data
public class LedgerReplyListPaginDTO {

	private List<LedgerReplyDTO> replyDTOList;  //전제 목록
	...
	public LedgerReplyListPaginDTO(List<LedgerReplyDTO> replyDTOList, int totalCount, 
			int page, int size) {
